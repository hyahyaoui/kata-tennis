...
class TennisGameRules {
    ...
    static boolean isGameWon(GameScore pointWinnerOldGameScore, GameScore otherPlayerGameScore) {
        return (pointWinnerOldGameScore.getNumberOfPointWon() >= GameScore.FOURTY.getNumberOfPointWon())
                && (pointWinnerOldGameScore.getNumberOfPointWon() > otherPlayerGameScore.getNumberOfPointWon());
    }
